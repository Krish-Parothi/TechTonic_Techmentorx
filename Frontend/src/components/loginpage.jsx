...
const LoginPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Email/password authentication will be handled by your backend with JWT
        // For now, just navigate to trip selection
    ...
    const handleGoogleLogin = async () => {
        try {
            ...
            // Supabase will handle the redirect to /trip-selection
        } catch (err) {
            ...
            <div className="w-full max-w-md bg-white px-6 py-6 text-center my-8 rounded-2xl border border-gray-200 shadow-sm scale-90">
                ...
                <div className="flex flex-col gap-3 mb-6">
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center justify-center gap-3 px-5 py-3 border border-gray-300 bg-white rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {loading ? (
                            <>
